...
def getSetup(figsize: tuple[float, float], gridd: tuple[int, int], multz=None) -> tuple[list[Axes], matplotlib.figure.Figure]:
    """Establish figure set-up with subplots."""
    sns.set_theme(style="whitegrid", font_scale=0.7, color_codes=True, palette="colorblind", rc={"grid.linestyle": "dotted", "axes.linewidth": 0.6})

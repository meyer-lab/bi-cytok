...
plot_configs = {
    ...
    "emd": {
        ...
        "title": "EMD vs Conversion Factor",
        "log_y": True,
        "legend": True,
    },
    "kl": {
        ...
        "title": "KL Divergence vs Conversion Factor",
        "log_y": False,
        "legend": True,
    },
}
...
#| fig-cap: "Binding model selectivity vs conversion factor"
...
```{python}
#| label: fig-scale-emd
#| fig-cap: "EMD vs conversion factor (log scale)"
plot_scale_panel(plot_configs["emd"])
```

```{python}
#| label: fig-scale-kl
#| fig-cap: "KL Divergence vs conversion factor"

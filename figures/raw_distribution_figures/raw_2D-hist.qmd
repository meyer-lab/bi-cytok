...
targ_cell = "CD4 Naive"
off_targ_cell_types = ["CD4 TCM", "CD8 TCM", "CD4 Naive", "CD4 Proliferating", "Treg", "CD4 CTL", "CD8 TEM", "CD8 Proliferating", "CD8 Naive"]
sample_size = 2500
...
for i, cell_type in enumerate(
    ...
    ax_top.hist(
        x_data, bins=30, alpha=0.6, color=colors[i], label=f"{cell_type_labels[i]} only"
    )
...
for i, cell_type in enumerate(
    ...
    ax_right.hist(y_data, bins=30, alpha=0.6, color=colors[i], orientation="horizontal")

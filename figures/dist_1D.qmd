...
if receptors_of_interest is not None:
    valid_columns = [col for col in sampleDF.columns if col in receptors_of_interest or col == "Cell Type"]
    sampleDF = sampleDF[valid_columns]
filtered_sampleDF = filter_receptor_abundances(
    sampleDF, targ_cell_type=targ_cell
)

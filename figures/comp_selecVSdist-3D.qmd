...
# receptors = ["CD27", "CD28", "CD314", "CD45RA"]
...
filtered_sample_df = filter_receptor_abundances(sample_df, targ_cell, whitelist=["TCR-1"])
...
for receptor_pair in receptor_pairs:
    ...
    time_end = time.time()
    print(f"Processing time for {receptor_pair}: {time_end - time_start} seconds")

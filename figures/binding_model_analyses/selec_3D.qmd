...
for rec1, rec2 in receptor_combinations:
    ...
    opt_selec, _, _ = optimize_affs(targ_abun, off_targ_abun, dose, valencies=valencies)
    ...
    time_end = time.time()
    print(
        f"Processed combination {rec1}, {rec2} in {time_end - time_start:.2f} seconds"
    )

# Create DataFrame with results
results_df = pd.DataFrame(
    {"Combination": combination_names, "Selectivity": selectivities}
)
```
...
print(
    "- Complex valencies: 2x signal receptor ligand, 1x ligand for each of two target receptors"
)

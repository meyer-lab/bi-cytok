...
# Summary
Generate plots to compare 1D and 2D distance metrics. The 1D distribution of a single epitope should match the 2D distribution of that epitope compared to itself.

...
```{python}
#| fig-cap: "Comparison of 1D vs 2D KL Divergence values"

plt.scatter(KL_div_vals_2D, KL_div_vals_1D, color="b")
plt.title(f"KL Divergence Values\nR²: {KL_div_r2:.2f}")
...
```{python}
#| fig-cap: "Comparison of 1D vs 2D EMD values"

plt.scatter(EMD_vals_2D_scaled, EMD_vals_1D, color="g")
plt.title(f"EMD Values\nR²: {EMD_r2:.2f}")
plt.xlabel("2D EMD")
plt.ylabel("1D EMD")
plt.show()
```

...
```{python}
#| fig-cap: "KL Divergence variation across sample sizes"
...
```{python}
#| fig-cap: "EMD variation across sample sizes"
...
```{python}
#| fig-cap: "Selectivity variation across sample sizes"

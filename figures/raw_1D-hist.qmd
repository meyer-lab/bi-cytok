...
- `fig_size`: Tuple of (width, height) in inches for figure dimensions
...
colors = ["#1d75bc", "#f7941d"]
cell_type_labels = ["Treg", "NK"]
...
if normalize:
    ...
    plt.xlabel(f"Number of {receptor} Receptor", fontsize=18)

...
plt.legend(handles=handles, title="Receptor Categories", loc="lower right")
...
plt.title(f"KL Divergence vs EMD for {targ_cell} vs Off-target Cells", fontsize=12)
plt.xlabel("Earth Mover's Distance (EMD)", fontsize=11)

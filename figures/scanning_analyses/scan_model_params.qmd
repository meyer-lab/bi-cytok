...
SPECIFIC_ANALYSES = {
    ...
    "set_vs_kx_loose": dict(
        comparison="sel_vs_kx",
        scan_label="Kx* upper bound 1e-5",
        color_by="gain",
    ),
    "sel_vs_kx_bivalent": dict(
        comparison="sel_vs_kx",
        scan_label="Bivalent Kx* upper bound 1e-5",
        color_by="gain",
    ),
    "sel_vs_kx_mixedval": dict(
        comparison="sel_vs_kx",
        scan_label="Mixed Valency Kx* upper bound 1e-5",
        color_by="gain",
    ),
...
```{python}
#| label: fig-set-vs-kx-cross-val
plot_specific_analysis("set_vs_kx_loose")

plot_specific_analysis("sel_vs_kx_bivalent")

plot_specific_analysis("sel_vs_kx_mixedval")
```
